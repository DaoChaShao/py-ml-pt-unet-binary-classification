...
**INTRODUCTION**
---
The [**Penn-Fudan**](https://www.cis.upenn.edu/~jshi/ped_html/) Pedestrian dataset is a benchmark dataset for pedestrian
detection and segmentation, jointly created by University of Pennsylvania and Fudan University. This dataset is
specifically designed for **pixel-level binary classification segmentation tasks**, focusing on distinguishing
pedestrians from background.

**DATA DESCRIPTION**
---

- **Number of Images**: 170 annotated images
- **Image Sources**: University of Pennsylvania campus and Fudan University campus
- **Image Format**: PNG format
- **Annotation Type**: Pixel-level binary masks
- **Classes**:
    - **Class 0**: Background (black pixels)
    - **Class 1**: Pedestrian (white pixels)
- **Mask Format**: Binary images in PNG format
